Idea:
 ...
 - for other targets, train multitask models on groups of targets where they are roughly the same number of training samples (that way they are roughly evenly weighted)
